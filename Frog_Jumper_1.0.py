...
pygame.display.set_caption('Froggy Jumper 1.0')
...
fly_x = 1000
fly_rect = fly_surf.get_rect(bottomleft=(fly_x, 200))

# OBJECT PICKED
snake_object = False
fly_object = False
object_picked = random.randrange(0, 3)
print(object_picked)
...
while True:
    ...
    if froggy_alive:
        ...
        if object_picked == 0:
            ...
            fly_x = 1000
            object_picked = 3
        elif object_picked == 1:
            snake_object = True
            fly_object = False
            snake_x = 1000
            object_picked = 3
        elif object_picked == 2:
            snake_object = True
            fly_object = False
            snake_x = 1000
            object_picked = 3
